...
namespace ModelDemo1.Controllers
{
    public class HomeController : Controller
    {
        ...
        public IActionResult SampleList()
        {
            ...
            people.Add(per);
            per = new Person() { FirstName = "Sally", LastName = "Smith", Email = "sally@abc.com", Born = 1990 };
            people.Add(per);
            per = new Person() { FirstName = "Julia", LastName = "Jones", Email = "julia@abc.com", Born = 1980};
            people.Add(per);
        ...
        public IActionResult Register(Person per)
        {
            if (per.Born > 2004)
            {
                ...
                //return Redirect"/home/showregister");
            }
            else
            {
                return View(per);
